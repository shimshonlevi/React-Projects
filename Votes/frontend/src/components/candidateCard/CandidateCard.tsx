...
import { ICandidate, removeVoteFromCandidate, updateVote } from '../../store/features/candidante/candidanteSlice';
import './candidateCard.css';
import { AppDispatch, RootState } from '../../store/store';
import { useDispatch, useSelector } from 'react-redux';
import { removeVote, setVote } from '../../store/features/user/userSlice';
