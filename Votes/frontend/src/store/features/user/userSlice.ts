...
import {IUser,objectID}from "../../../../../bakend/src/models/userModel"
...
export const loginUser = createAsyncThunk("/loginUser", async (userData: {username: string, password: string}): Promise<ResponseOfAPI> => {
